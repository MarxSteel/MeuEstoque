...
$dt = date("d/m/Y - H:i:s");
$ChamaFornecedor = "SELECT * FROM transporte";
 ...
 <div class="wrapper">
  ...
  <div class="content-wrapper">
   <section class="content-header">
    <h1>Transportadoras<small><?php echo $Titulo; ?></small></h1>
   </section>
   ...
   <div class="row">
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
     <div class="info-box">
      ...
      <div class="info-box-content"><br /><h4>Cadastrar Transportadora</h4></div>
        ...
        <div class="modal-content">
         ...
         <div class="modal-body">
          <form name="EdCad" id="name" method="post" action="" enctype="multipart/form-data">
           <div class="col-xs-8 form-group">Nome da Transportadora
           ...
           <div class="col-xs-4 form-group">Data de Cadastro
            ...
            <div class="col-xs-6">Tipo de Transporte
            ...
            <div class="col-xs-6">Perfil de Transporte
          ...
          <?php
           if(@$_POST["Tsenha"]){
            ...
            $AddCat = $PDO->query("INSERT INTO transporte (Nome, Tipo, Categoria, Obs, DataCadastro, Status) VALUES ('$nomeCat', '$tt', '$pt', '$Obs', '$dt', '1')");
            if($AddCat)
             {
              echo '
              <script type="text/JavaScript">alert("Transportadora Cadastrada");
        ...
        <table id="example1" class="table table-bordered table-striped">
         ...
         <?php 
          while ($VFor = $Forn->fetch(PDO::FETCH_ASSOC)): 
           echo '<tr>';
            echo '<td>' . $VFor['id_transp'] . '</td>';
            echo '<td>' . $VFor['Nome'] . '</td>';
            $TipoForn = $VFor['Tipo'];
            if ($TipoForn === "1") {
            echo '<td><span class="btn bg-purple btn-xs btn-flat btn-block disabled">Aéreo</span></td>'; 
            }
            elseif ($TipoForn === "2") {
            echo '<td><span class="btn bg-aqua btn-xs btn-flat btn-block disabled">Marítimo</span></td>'; 
            }
            elseif ($TipoForn === "3") {
            echo '<td><span class="btn bg-gray btn-xs btn-flat btn-block disabled">Terrestre</span></td>'; 
            }
            else{
            }
            $TipoCat = $VFor['Categoria'];
            if ($TipoCat === "1") {
            echo '<td><span class="btn bg-red btn-xs btn-flat btn-block disabled">Nacional</span></td>'; 
            }
            elseif ($TipoCat === "2") {
            echo '<td><span class="btn bg-primary btn-xs btn-flat btn-block disabled">Importado</span></td>'; 
            }
            else{
            }
            ?>
            <td>
            <a class="btn btn-default btn-xs btn-block" href="javascript:abrir('VerT.php?ID=<?php echo $VFor['id_transp']; ?>');">
